...
$(document).ready(function() {
	$('#table_resourseList').bootstrapTable({
		url : path + 's/resourse/resourseList.do', // 请求后台的URL（*）
		method : 'get', // 请求方式（*）
		...
		}, 
		{
			...
			formatter : function(value, row, index) {  
                //return index + 1;  
                var page = $('#table_resourseList').bootstrapTable("getPage");  
	...
	$("#queryButton").click(function() {
		$('#table_resourseList').bootstrapTable('refresh');
	});
