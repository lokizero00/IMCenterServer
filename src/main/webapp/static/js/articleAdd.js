...
$(document).ready(function() {
	showSel("#articleAdd_status", "article_status");

	$("#btnSubmit").click(function() {
		var r = confirm("确定要执行？");
		if (r === true) {
			var param = {};
			param.title = $("#articleAdd_title").val();
			param.content = $("#articleAdd_content").summernote('code');
			param.status = $("#articleAdd_status").val();
			$.ajax({
				"type" : 'post',
				"url" : path + 's/article/articleAdd.do',
				"dataType" : "json",
				"data" : param,
