...
<div class="panel panel-default">
	...
	<div class="panel panel-default">
	    <div class="panel-heading" >
	       	<span class="glyphicon glyphicon-list-alt"></span> 意向金列表
	    </div>
	    <div class="panel-body" style="padding-top: 1px;">
	       	 <input type="hidden" id="contextPath" value="${contextPath}" />
			<table id="table_intentionList" class="tb_list"></table>
	    </div>
	</div>
	...
	<script src="<%=basePath%>static/js/intentionList.js"></script>
</body>
</html>