...
<body>
			...
			<tr>
				...
				<td colspan="5">
					<div class="form-group">
						...
						<input type="hidden"
							id="enterpriseCertificationList_hi_createTimeStart" value="" /><br />
					</div>
					<div class="form-group">
						...
						<input type="hidden"
							id="enterpriseCertificationList_hi_createTimeEnd" value="" /><br />
					</div>
				</td>
				<td>状态：</td>
				<td><select id="enterpriseCertificationList_queryStatus">
				</select></td>
			</tr>
			<tr>
				<td>
	...
	<div class="container-fluid">
		...
		<table id="table_enterpriseCertificationList"></table>
	</div>
