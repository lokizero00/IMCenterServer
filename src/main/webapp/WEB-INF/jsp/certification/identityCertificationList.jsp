...
<body>
			...
			<tr>
				...
				<td colspan="5">
					<div class="form-group">
						...
						<input type="hidden"
							id="identityCertificationList_hi_createTimeStart" value="" /><br />
					</div>
					<div class="form-group">
						...
						<input type="hidden"
							id="identityCertificationList_hi_createTimeEnd" value="" /><br />
					</div>
				</td>
				<td>状态：</td>
				<td><select id="identityCertificationList_queryStatus">
				</select></td>
			</tr>
			<tr>
				<td>
	...
	<div class="container-fluid">
		...
		<table id="table_identityCertificationList"></table>
	</div>
	...
	<script src="<%=basePath%>static/js/identityCertificationList.js"></script>
