...
<body>
	...
	<script src="<%=basePath%>static/js/enterpriseCertificationDetail.js"></script>
	<div class="panel panel-default">
	    ...
	    <div class="form-group">
			<div align="center">
				...
				data-target='#ecVerifyModal' class="btn btn-primary">审核</button>
	...
	<!-- 模态框（Modal） -->
	<div class="modal fade" id="ecVerifyModal" tabindex="-1" role="dialog"
				...
				<div class="modal-body">
					<div>
						<label for="name">请选择审核结果</label> <select
							id="enterpriseCertificationDetail_verifyResult">
							<option value="verify_pass">通过</option>
							<option value="verify_refuse">不通过</option>
						</select>
					</div>
					<div class="form-group" id="div_enterpriseCertificationRefuseReason"
						style="display: none;">
						<label for="name">拒绝原因</label>
						<textarea class="form-control"
							id="ta_enterpriseCertificationRefuseReason" rows="3"></textarea>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
					<button type="button" onclick="enterpriseCertificationVerify();"
