...
<body>
	...
	<!-- 模态框（Modal） -->
	<div class="modal fade" id="ecVerifyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group" id="div_enterpriseCertificationRefuseReason" >
						...
						<textarea class="form-control" id="ta_enterpriseCertificationRefuseReason" rows="3"></textarea>
					</div>
				</div>
