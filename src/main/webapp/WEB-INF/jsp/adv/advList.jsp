...
<body>
	<div class="panel panel-default">
	    <div class="panel-heading" >
	       	<h3 class="panel-title"><span class="glyphicon glyphicon-book"></span> 广告管理</h3>
	    </div>
	    <div class="panel-body">
				...
				<tr>
					<td>标 题：</td>
					<td>
						<input type="text" id="advList_queryTitle" name="advList_queryTitle" value="">
					</td>
					<td>创建时间：从</td>
					<td>
						<div class="input-group date form_date col-md-5" data-date=""
								...
								<input class="form-control" style="width: 200px; height: 29px" id="advList_queryCreateTimeStart"
							...
							<input type="hidden" id="advList_hi_createTimeStart" value="" />
					</td>
					<td>到：</td>
					<td>
						<div class="input-group date form_date col-md-5" data-date=""
								...
								<input class="form-control" style="width: 200px; height: 29px" id="advList_queryCreateTimeEnd"
									size="16" type="text" value="" readonly> <span
									class="input-group-addon"><span
									class="glyphicon glyphicon-remove"></span></span> <span
									class="input-group-addon"><span
							...
							<input type="hidden" id="advList_hi_createTimeEnd" value="" />
					</td>
					<td></td>
					<td></td>
				</tr>
	...
	<div class="panel panel-default">
	    <div class="panel-heading" >
	       	<span class="glyphicon glyphicon-list-alt"></span> 广告信息列表
	    </div>
