...
<body>
	...
	<div class="form-horizontal" >
		...
		<div class="form-group">
			<label for="noticeAdd_title" class="col-sm-2 control-label">标题</label>
			<div class="col-sm-8">
		...
		<div class="form-group">
			<label for="noticeAdd_content" class="col-sm-2 control-label">内容</label>
			<div class="col-sm-8">
				<textarea class="form-control" rows="3" id="noticeAdd_content"
