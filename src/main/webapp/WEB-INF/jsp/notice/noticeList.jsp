...
<body>
	<div id="queryDiv">
		<table width="100%">
			<tr>
				<td>标题：</td>
				<td><input type="text" id="noticeList_queryTitle"
					name="noticeList_queryTitle" value=""></td>
				<td>类型：</td>
				<td><select name="noticeList_queryRelationType"
					id="noticeList_queryRelationType">
				</select></td>
				<td>创建时间：</td>
				<td colspan="3">
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-5" data-date="" todayBtn="linked"
							...
							<input class="form-control" id="noticeList_queryCreateTimeStart" size="16" type="text" value=""
								readonly> <span class="input-group-addon"><span
								class="glyphicon glyphicon-remove"></span></span> <span
								class="input-group-addon"><span
								class="glyphicon glyphicon-calendar"></span></span>
						</div>
						<input type="hidden" id="noticeList_hi_createTimeStart" value="" /><br />
					</div>
					<div class="form-group">
						...
						<div class="input-group date form_date col-md-5" data-date=""
							...
							data-link-format="yyyy-mm-dd">
							<input class="form-control" id="noticeList_queryCreateTimeEnd" size="16" type="text" value=""
								readonly> <span class="input-group-addon"><span
								class="glyphicon glyphicon-remove"></span></span> <span
								class="input-group-addon"><span
								class="glyphicon glyphicon-calendar"></span></span>
						</div>
						<input type="hidden" id="noticeList_hi_createTimeEnd" value="" /><br />
					</div>
				</td>
			</tr>
			<tr>
	...
	<div class="container-fluid">
		...
		<table id="table_noticeList"></table>
	</div>
