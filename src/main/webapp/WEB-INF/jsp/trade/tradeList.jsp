...
<body>
	...
	<table>
		<tr>
	    		<td>标题：</td>
	    				<td>
	    					<input type="text" id="tradeList_queryTitle" name="tradeList_queryTitle" value="" >
	    				</td>
	    				<td>类型：</td>
	    				<td>
						<select name="tradeList_queryType" id="tradeList_queryType" >
						</select>
					</td>
	    				<td>编号：</td>
	    				<td>
	    					<input type="text" id="tradeList_querySn" name="tradeList_querySn" value="" >
	    				</td>
	    				<td>状态：</td>
		    			<td>
						<select name="tradeList_queryStatus" id="tradeList_queryStatus" >
						</select>
					</td>
	    			</tr>
	    			<tr>
	    				<td>行业：</td>
	    				<td>
	    					<select name="tradeList_queryIndustryCode" id="tradeList_queryIndustryCode" >
						</select>
	    				</td>
	    				<td>发票要求：</td>
		    			<td>
						<select name="tradeList_queryInvoiceCode" id="tradeList_queryInvoiceCode" >
						</select>
					</td>
		    			<td>支付方式：</td>
		    			<td>
						<select name="tradeList_queryPayCode" id="tradeList_queryPayCode" >
						</select>
					</td>
					<td>
