...
public class IntentionMobileController {
	...
	public String getIntention(HttpServletRequest request,int userId,ModelMap mm) {
		ServiceResult<IntentionVO> returnValue=intentionService.getIntention(userId);
		if (returnValue!=null) {
	...
	public String getIntentionLog(HttpServletRequest request,int userId,int intentionId,int adminId,String type,Integer pageNo, Integer pageSize,ModelMap mm) {
		ServiceResult<PagedResult<IntentionLogVO>> returnValue=intentionService.getIntentionLog(userId,intentionId, adminId, type,pageNo,pageSize);
		if (returnValue!=null) {
			mm.addAttribute("resultCode", returnValue.getResultCode().getCode());
			mm.addAttribute("msg", returnValue.getResultCode().getMessage());
			mm.addAttribute("resultObj", returnValue.getResultObj());
	...
	public String getUserBankcardList(HttpServletRequest request,int userId,ModelMap mm) {
		ServiceResult<List<UserBankcardVO>> returnValue=intentionService.getUserBankcard(userId);
		if (returnValue!=null) {
			mm.addAttribute("resultCode", returnValue.getResultCode().getCode());
			mm.addAttribute("msg", returnValue.getResultCode().getMessage());
			mm.addAttribute("resultObj", returnValue.getResultObj());
	...
	public String addUserBankcard(HttpServletRequest request,UserBankcardVO userBankcardVO,ModelMap mm) {
		ServiceResult<Void> returnValue=intentionService.addUserBankcard(userBankcardVO);
		if (returnValue!=null) {
			mm.addAttribute("resultCode", returnValue.getResultCode().getCode());
			mm.addAttribute("msg", returnValue.getResultCode().getMessage());
			mm.addAttribute("resultObj", returnValue.getResultObj());
