...
public class BaseService {
	...
	protected int addIntentionJournal(String type, int intentionId, int userId, String innerBusiNo, String outRequestNo,
			BigDecimal amount, String logContent) {
	...
	protected String getImageRequestUrl(HttpServletRequest request, String name) {
		if (request != null) {
			String path = getSettingValue("transferProtocol") + "://" + request.getHeader("host")
	...
	protected void addNotice(Integer noticeType, String content, Integer relationId,List<Integer> userIdList) {
		if (noticeType != null && noticeType > 0) {
			...
			case 1:
				...
				notice.setRelationType("article");
